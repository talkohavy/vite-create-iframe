    ...
    <div className='p-6'>
      ...
      <div className='mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
        <div className='p-4 border rounded-lg dark:border-gray-600'>
          ...
          <p className='text-sm text-gray-500'>Description of Box 1</p>
        </div>

        <div className='p-4 border rounded-lg dark:border-gray-600'>
          <h3 className='font-semibold'>Box 2</h3>
          <p className='text-sm text-gray-500'>Description of Box 2</p>
        </div>

        <div className='p-4 border rounded-lg dark:border-gray-600'>
          <h3 className='font-semibold'>Box 3</h3>
          <p className='text-sm text-gray-500'>Description of Box 3</p>
        </div>
      </div>
    </div>
  );
